...
const Nav = () => {
  ...
  return <nav className={'flex flex-col items-center xl:justify-center gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[2%] z-50 w-full top-0 xl:w-16 xl:max-w-md xl:h-screen'}>
